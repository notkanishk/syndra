    ...
    <div className="flex min-h-[60dvh] items-center justify-center px-5">
      <div className="w-full max-w-[52ch] rounded-[18px] border border-line-strong bg-surface-2 px-6 py-7">
        ...
        <p className="mt-2 text-[14.5px] leading-[1.55] text-muted">
          No page in Syndra has this address. If you followed a link from somewhere else, the
          link is wrong rather than the thing it pointed at being gone — a person or a bundle
          that has been removed says so on its own page.
        </p>
        <Link
          href="/"
