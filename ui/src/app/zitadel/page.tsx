  ...
  return (
    <div className="p-8 space-y-6 animate-fade-in-up">
      <header className="flex flex-col gap-2">
        <p className="text-xs uppercase tracking-[0.22em] text-muted">Operations</p>
        <h1 className="text-2xl font-semibold text-foreground">Zitadel Diagnostics</h1>
        <p className="text-sm text-muted max-w-2xl">
          Exercises the live <code className="text-foreground">/api/v1/zitadel/*</code> management surface —
          health probe, projects &amp; roles, users &amp; grants. Use this to verify a new Zitadel
          deployment or service-account rotation before trusting the orchestrator.
        </p>
      </header>
