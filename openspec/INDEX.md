...
| [Reconciliation as a Merge](changes/reconciliation-as-merge/) | 4 | Proposed | [proposal](changes/reconciliation-as-merge/proposal.md) / [design](changes/reconciliation-as-merge/design.md) / [tasks](changes/reconciliation-as-merge/tasks.md) — reconciliation compares two states and cannot tell who changed a value, so it resolves every difference by overwriting. Records a merge base and classifies instead: fast-forward, already merged, drift, conflict, deleted upstream |
