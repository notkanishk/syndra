...
- **Modifies:** `backend/internal/zitadel/orchestrator.go` (interface), `backend/internal/directory/{zitadel.go,directory_test.go}`, `backend/internal/seed/demo_test.go`, `backend/internal/services/roles_test.go`, `backend/internal/zitadel/orchestrator_test.go` (mock extensions), `openspec/INDEX.md`, `openspec/changes/mkauth-core-architecture/ROADMAP.md`, `openspec/changes/mkauth-core-architecture/specs/feature-coverage.md`.
