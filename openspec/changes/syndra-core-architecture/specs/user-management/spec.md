...
The system MUST allow admins to filter the global user list across multiple dimensions to perform precise audits and maintenance as part of Syndra's admin-console-first workflow.
