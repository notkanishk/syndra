...
Admins MUST be able to define new roles for any project managed by Syndra.
...
- **THEN** Syndra MUST propagate this creation to Zitadel and update the local role cache.
