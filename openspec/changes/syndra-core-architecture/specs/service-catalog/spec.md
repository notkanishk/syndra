...
## Service Discovery
The portal MUST present a gallery of all "Published" applications available in the Syndra ecosystem.

### Scenario: Browsing helpdesk access
- **GIVEN** a standard user logs into the Syndra Portal
...
- **THEN** Syndra MUST initiate an `AccessRequest` for the `laser_lab_basic` Bundle.
...
- **WHEN** they visit the Syndra Portal
