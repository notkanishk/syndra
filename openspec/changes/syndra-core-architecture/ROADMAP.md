...
- [ ] **LLDAP Reconciliation**: Periodic full-sync comparing Syndra provisioning state against LLDAP group memberships, overwriting LLDAP drift per one-way authority rule. → [ldap-sync spec](specs/ldap-sync/spec.md)
